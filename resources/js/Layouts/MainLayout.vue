<template>
    ...
    <div v-show="categoryMenu" @click="categoryMenu = false" class="fixed inset-0 z-40"></div>

    <header>
        <nav class="max-w-screen-xxl mx-auto flex justify-between bg-green-400 dark:bg-slate-800 text-white px-3 space-x-1">
            <!-- Left Menus -->
            <div v-if="user" class="flex items-center">
                ...
                <div class="relative">
                    ...
                    <div v-show="categoryMenu" @click="categoryMenu = false" class="absolute z-50 top-9 left-0 bg-green-600 rounded-md border-green-400 border overflow-hidden w-40">
                        ...
                        <Link @click="categoryMenu = !categoryMenu"
                              class="block text-left px-3 py-1 hover:opacity-50"
                              :href="route('md.index')">Managing Director</Link>
    ...
    <main class="max-w-screen-xxl mx-auto p-3">
        <slot/>
    </main>
</template>
