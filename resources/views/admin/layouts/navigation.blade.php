            ...
            <div class="font-bold text-right">
                ...
                <div>
                    ...
                    <form method="POST" action="{{ route('admin.logout') }}">
                        @csrf
                        <a href="{{ route('admin.logout') }}" onclick="event.preventDefault(); this.closest('form').submit();" class="text-gray-700 dark:text-white hover:bg-red-100 focus:ring-4 focus:ring-gray-300  rounded-lg text-xs px-4 py-2 md:px-5 md:py-2.5 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">{{ __('Log Out') }}</a>
                    </form>
                </div>
            </div>
